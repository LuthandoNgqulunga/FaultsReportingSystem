...
public class OperatorPage extends ListActivity
{
    ArrayList arrEmp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_operator_page);
         ...
         arrEmp = getMyList();
         setListAdapter(new ArrayAdapter<String>(this,R.layout.activity_list_of_issues,R.id.ListOfIssue1,arrEmp));
         if(arrEmp.size()==0){
             Toast.makeText(getApplicationContext(), "there are no issues assigned to you", Toast.LENGTH_LONG).show();
         }
    }
    ...
    protected void onListItemClick(ListView i, View v, int position, long id)
    {
        ...
        operatorIncID =(new Intent(OperatorPage.this,SpecificOperatorIssue.class));
